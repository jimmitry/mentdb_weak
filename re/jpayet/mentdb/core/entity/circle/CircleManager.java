...
public class CircleManager {
	...
	public static JSONArray getIds(long sessionId, String level, String r_th) throws Exception {
		...
		JSONObject recRelation = Record.getNode(sessionId, r_th);
		...
		if (circle_id==null) return result;
			...
			JSONObject c = Record.getNode(sessionId, circle_id);
	...
	//Get ids
	@SuppressWarnings("unchecked")
	public static JSONArray getIds(long sessionId, String level, String lang, String r_th) throws Exception {
		...
		if (circle_id==null) return result;
			...
			for(int i=0;i<result.size();i++) {
				...
				if (((String) Record.getNode(sessionId, curRelation).get("l")).equals(lang)) {
	...
	//Get ids
	@SuppressWarnings("unchecked")
	public static String getId(long sessionId, String level, String lang, String r_th) throws Exception {
	...
	public static boolean contains(long sessionId, String level, String r_th, String r_th_toFind) throws Exception {
	...
	//Show all circles
	public static JSONObject showCircle(long sessionId, String level, String r_th) throws Exception {
		...
		if (circle_id==null) return new JSONObject();
			...
			return Record.getNode(sessionId, circle_id);
	...
	//Add circle
	@SuppressWarnings("unchecked")
	public static void setCurrentCircle(long sessionId, String level, String r_th, String currentCircle) throws Exception {
		
		JSONObject recRelation = Record.getNode(sessionId, r_th);
		((JSONObject) recRelation.get("c")).put(level, currentCircle);
		Record.update(sessionId, r_th, recRelation.toJSONString());
		
	}

	//Add relations into a circle
	@SuppressWarnings("unchecked")
	public static String mergeCircle(long sessionId, String level, String relationId1, String positions1, String relationId2, String positions2, EnvManager env, SessionThread session) throws Exception {
		...
		JSONObject recRelation1 = Record.getNode(sessionId, relationId1);
		...
		JSONObject recRelation2 = Record.getNode(sessionId, relationId2);
		...
		if (nbPosition!=RelationManager.showThoughtNodes(sessionId, relationId2).size()) {
	
			throw new Exception("Sorry, the number of position is not equals to the number of thought/relation into the relation "+relationId2+" ("+RelationManager.showSentence(sessionId, relationId2, env, session)+").");
		...
		if (nbPosition!=RelationManager.showThoughtNodes(sessionId, relationId1).size()) {
	
			throw new Exception("Sorry, the number of position is not equals to the number of thought/relation into the relation "+relationId1+" ("+RelationManager.showSentence(sessionId, relationId1, env, session)+").");
		...
		if (circle_id_1==null) currentCircle1 = new JSONObject();
			...
			currentCircle1 = Record.getNode(sessionId, circle_id_1);
		}
		...
		if (circle_id_1 == null) {
			...
			circle_id_1 = "CI["+SequenceManager.incr(sessionId, "circle")+"]";
			Record.add(sessionId, circle_id_1, currentCircle1.toJSONString());
			
		} else {
			
			Record.update(sessionId, circle_id_1, currentCircle1.toJSONString());
		...
		for(Object o1 : currentCircle1.keySet()) {
			...
			setCurrentCircle(sessionId, level, r1, circle_id_1);
			setCurrentCircle(sessionId, level, r2, circle_id_1);
		...
		recRelation2 = Record.getNode(sessionId, relationId2);
		...
		Record.update(sessionId, relationId2, recRelation2.toJSONString());
	...
	@SuppressWarnings("unchecked")
	public static String mergeCircle(long sessionId, String level, String r_th_1, String r_th_2, EnvManager env, SessionThread session) throws Exception {
		...
		//Try to get the relation 1
		JSONObject recRelation1 = Record.getNode(sessionId, r_th_1);
		...
		//Try to get the relation 2
		JSONObject recRelation2 = Record.getNode(sessionId, r_th_2);
		...
		if (circle_id_2==null) currentCircle2 = new JSONObject();
			...
			currentCircle2 = Record.getNode(sessionId, circle_id_2);
		}
		...
		if (circle_id_2 != null && !circle_id_2.equals(circle_id_1)) {
			...
			Record.remove(sessionId, circle_id_2);
		...
		Record.update(sessionId, r_th_2, recRelation2.toJSONString());
	...
	//Delete circle
	@SuppressWarnings("unchecked")
	public static void deleteCircle(long sessionId, String level, String r_th) throws Exception {
		...
		if (circle_id != null) {
			...
			if (currentCircle.size()==0) Record.remove(sessionId, circle_id);
			else Record.update(sessionId, circle_id, currentCircle.toJSONString());
		...
		for(Object d : deletedRelations.keySet()) {
			...
			setCurrentCircle(sessionId, level, r, null);
		...
		for(Object o1 : currentCircle.keySet()) {
			...
			setCurrentCircle(sessionId, level, r1, circle_id);
			setCurrentCircle(sessionId, level, r2, circle_id);
	...
	//Exist circle
	public static String existCircle(long sessionId, String level, String r_th) throws Exception {
