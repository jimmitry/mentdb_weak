...
public class MQLDocumentation {
	...
	public static String menu_to_html() {
		...
		for (Entry<String, Vector<MQLDocumentation>> e : MQLDocumentation.functions.entrySet()) {
			...
			if (!ghost_functions.containsKey(e.getKey())) {
				...
				menu += "<a style='color: #000;font-weight:bold;font-size: 14px;padding:2px 8px 7px 0px;float:left;display:inline-block;width:400px' href='#mql_"+e.getKey()+"'>"+e.getKey()+"</a>";
	
				result += "<div style='line-height: 32px;clear:left;font-size: 13px;font-weight:bold;padding:0px 8px 4px 0px;'><a href='mql_"+e.getKey().toLowerCase().replace(" ", "_")+".html' id='mql_"+e.getKey()+"' style='color: #000;padding: 5px 8px;border-bottom: 1px solid #D9DEE4;margin-left: -8px;width: 100%;display: block;font-size:16px'>"+e.getKey()+"</a></div>";
				...
				for(int i=0;i<e.getValue().size();i++) {
					...
					if (currentFunction.webSocket) result += "<a title='"+currentFunction.warning.replace("'", "&#39;")+"' style='"+valid+";font-size: 12px;padding:2px 8px 7px 0px;float:left;display:inline-block;width:400px' href='mql_"+e.getKey().toLowerCase().replace(" ", "_")+".html#fx_"+currentFunction.functionId.replace(" ", "_")+"'>@"+currentFunction.functionId+(!currentFunction.synonymous.equals("")?" <span style='font-size:8px;'>"+currentFunction.synonymous+"</span>":"")+"</a>";
					else result += "<a title='"+currentFunction.warning.replace("'", "&#39;")+"' style='"+valid+";font-size: 12px;padding:2px 8px 7px 0px;float:left;display:inline-block;width:400px' href='mql_"+e.getKey().toLowerCase().replace(" ", "_")+".html#fx_"+currentFunction.functionId.replace(" ", "_")+"'>"+currentFunction.functionId+(!currentFunction.synonymous.equals("")?" <span style='font-size:8px;'>"+currentFunction.synonymous+"</span>":"")+"</a>";
	...
	public static String mqlPage_to_html() throws Exception {
		...
		for (Entry<String, Vector<MQLDocumentation>> e : MQLDocumentation.functions.entrySet()) {
			...
			result += "<div style='line-height: 32px;clear:left;font-size: 13px;font-weight:bold;padding:0px 8px 4px 0px;font-size:24px;'>"+e.getKey()+"</div>";
			if (page_description.containsKey(e.getKey())) result += "<div style='border-bottom: 1px solid #D9DEE4;'></div><h1 style='margin-top: 25px;margin-bottom: 15px;font-size: 14px;color: #3a3a3a;font-weight: normal;line-height: 25px;'>"+page_description.get(e.getKey())+"</h1>";
			if (!ghost_functions.containsKey(e.getKey())) {
			...
			for(int i=0;i<e.getValue().size();i++) {
				...
				result += "<div style='-moz-box-sizing: border-box;box-sizing: border-box;border-bottom:1px #F0F0F0 solid;padding-bottom:20px;font-size:12px'>";
				result += "<div id='fx_"+currentFunction.functionId.replace(" ", "_")+"'><h2 style='color:#000'>"+(currentFunction.webSocket?"@":"")+currentFunction.functionId;
				...
				if (currentFunction.example1!=null) {
					...
					if (e.getKey().equals("XML")) {
						result += "<pre style='color:#000;margin-top: 0px;'><span style='font-size: 14px;'><b>admin</b></span><br>"+Misc.splitCommandHtml(currentFunction.example1.replace("<", "&lt;"))+"</pre>";
						result += "<pre style='color:#000'><span style='font-size: 14px;'><b>mentdb</b></span><br>"+Misc.splitCommandHtml(currentFunction.result1.replace("<", "&lt;"))+"</pre>";
					} else {
						result += "<pre style='color:#000;margin-top: 0px;'><span style='font-size: 14px;'><b>admin</b></span><br>"+Misc.splitCommandHtml(currentFunction.example1)+"</pre>";
						result += "<pre style='color:#000'><span style='font-size: 14px;'><b>mentdb</b></span><br>"+Misc.splitCommandHtml(currentFunction.result1)+"</pre>";
					}
					if (currentFunction.valid && Start.CHECK_DOCUMENTATION==1) {
						...
						try {
							...
							result += "<pre style='color:#090'><span style='font-size: 14px;'><b>checker</b></span><br>"+Misc.splitCommandHtml(mqlResult)+"</pre>";
							result += "<pre style='color:#009'><span style='font-size: 14px;'><b>checker</b></span><br>"+Misc.splitCommandHtml(mqlResult.replace("\n", "&lt;br&gt;").replace("\\", "\\\\").replace("\"", "\\\""))+"</pre>";
							
						} catch (Exception z) {
							
							Transaction.rollback(0);
							mqlResult = z.getMessage()+"";
							result += "<pre style='color:#F00'><span style='font-size: 14px;'><b>checker</b></span><br>"+Misc.splitCommandHtml(mqlResult)+"</pre>";
				...
				if (currentFunction.example2!=null) {
					result += "<div style='overflow:auto;line-height: 20px;margin-top: 15px;padding:10px 15px 0px 15px;background-color: #F8F8F8;border:1px #F0F0F0 solid'>";if (e.getKey().equals("XML")) {
						result += "<pre style='color:#000;margin-top: 0px;'><span style='font-size: 14px;'><b>admin</b></span><br>"+Misc.splitCommandHtml(currentFunction.example2.replace("<", "&lt;"))+"</pre>";
						result += "<pre style='color:#000'><span style='font-size: 14px;'><b>mentdb</b></span><br>"+Misc.splitCommandHtml(currentFunction.result2.replace("<", "&lt;"))+"</pre>";
					} else {
						result += "<pre style='color:#000;margin-top: 0px;'><span style='font-size: 14px;'><b>admin</b></span><br>"+Misc.splitCommandHtml(currentFunction.example2)+"</pre>";
						result += "<pre style='color:#000'><span style='font-size: 14px;'><b>mentdb</b></span><br>"+Misc.splitCommandHtml(currentFunction.result2)+"</pre>";
					}
					if (currentFunction.valid && Start.CHECK_DOCUMENTATION==1) {
						String mqlResult = "";
						try {
				...
				if (currentFunction.example3!=null) {
					result += "<div style='overflow:auto;line-height: 20px;margin-top: 15px;padding:10px 15px 0px 15px;background-color: #F8F8F8;border:1px #F0F0F0 solid'>";
					if (e.getKey().equals("XML")) {
						result += "<pre style='color:#000;margin-top: 0px;'><span style='font-size: 14px;'><b>admin</b></span><br>"+Misc.splitCommandHtml(currentFunction.example3.replace("<", "&lt;"))+"</pre>";
						result += "<pre style='color:#000'><span style='font-size: 14px;'><b>mentdb</b></span><br>"+Misc.splitCommandHtml(currentFunction.result3.replace("<", "&lt;"))+"</pre>";
					} else {
						result += "<pre style='color:#000;margin-top: 0px;'><span style='font-size: 14px;'><b>admin</b></span><br>"+Misc.splitCommandHtml(currentFunction.example3)+"</pre>";
						result += "<pre style='color:#000'><span style='font-size: 14px;'><b>mentdb</b></span><br>"+Misc.splitCommandHtml(currentFunction.result3)+"</pre>";
					}
					if (currentFunction.valid && Start.CHECK_DOCUMENTATION==1) {
						String mqlResult = "";
						try {
	...
	public static String mqlFuntion_to_html(String idClass, String idFunction) throws Exception {
		...
		for(int i=0;i<e.size();i++) {
			...
			if (currentFunction.functionId.equals(idFunction)) {
				...
				result += "<div style='-moz-box-sizing: border-box;box-sizing: border-box;padding-bottom:20px;font-size:12px'>";
				result += "<div id='fx_"+currentFunction.functionId.replace(" ", "_")+"'><h2 style='color:#000'><a href='#top'><img src='images/top.png' style='width:16px'></a> "+(currentFunction.webSocket?"@":"")+currentFunction.functionId;
				if (currentFunction.parameters.size()>0) for(int r=0;r<currentFunction.parameters.size();r++) {
				...
				if (currentFunction.example1!=null) {
					result += "<div style='overflow:auto;line-height: 20px;margin-top: 15px;padding:10px 15px 0px 15px;background-color: #F8F8F8;border:1px #F0F0F0 solid'>";
					result += "<div style='color:#000'><span style='font-size: 14px;'><b>admin</b></span><br>"+Misc.splitCommandHtml(currentFunction.example1)+"</div>";
					result += "<pre style='color:#000'><span style='font-size: 14px;'><b>mentdb</b></span><br>"+Misc.splitCommandHtml(currentFunction.result1)+"</pre>";
					result += "</div>";
				}
				if (currentFunction.example2!=null) {
					result += "<div style='overflow:auto;line-height: 20px;margin-top: 15px;padding:10px 15px 0px 15px;background-color: #F8F8F8;border:1px #F0F0F0 solid'>";
					result += "<div style='color:#000'><span style='font-size: 14px;'><b>admin</b></span><br>"+Misc.splitCommandHtml(currentFunction.example2)+"</div>";
					result += "<pre style='color:#000'><span style='font-size: 14px;'><b>mentdb</b></span><br>"+Misc.splitCommandHtml(currentFunction.result2)+"</pre>";
					result += "</div>";
				}
				if (currentFunction.example3!=null) {
					result += "<div style='overflow:auto;line-height: 20px;margin-top: 15px;padding:10px 15px 0px 15px;background-color: #F8F8F8;border:1px #F0F0F0 solid'>";
					result += "<div style='color:#000'><span style='font-size: 14px;'><b>admin</b></span><br>"+Misc.splitCommandHtml(currentFunction.example3)+"</div>";
					result += "<pre style='color:#000'><span style='font-size: 14px;'><b>mentdb</b></span><br>"+Misc.splitCommandHtml(currentFunction.result3)+"</pre>";
					result += "</div>";
				}
				result += "</div>";
	...
	public static void init() throws Exception {
		...
		mql = new MQLDocumentation(true, "relation create", "To insert a new relation", "relation create (concat \n" + 
				...
				") en;", "RL[v]", "relation show sentence RL[v]", "something is something", null, null, false, "relation create|insert|add");
		...
		mql = new MQLDocumentation(true, "circle exist", "To chek if a link already existe into a circle", "circle exist \"r\" [R1]", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("level", "The level (ex: th|r)", "string", true));
		mql.addParam(new MQLParam("relationIdToFind", "The relation id to find", "string", true));
		functions.get("Circle").add(mql);
		mql = new MQLDocumentation(true, "circle contains", "To chek if a circle contains a relation", "circle contains \"r\" [R1] [R2]", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("level", "The level (ex: th|r)", "string", true));
		mql.addParam(new MQLParam("relationId", "The relation id", "string", true));
		mql.addParam(new MQLParam("relationIdToFind", "The relation id to find", "string", true));
		functions.get("Circle").add(mql);
		...
		mql.addParam(new MQLParam("value", "The value", "integer", true));
		functions.get("Sequence").add(mql);
		mql = new MQLDocumentation(true, "sequence generate update", "To generate an update sequence update request", "sequence generate update \"test\"", "sequence update \"test\" \"67\";", null, null, null, null, false, "");
		mql.addParam(new MQLParam("key", "The key", "string", true));
		functions.get("Sequence").add(mql);
		...
		mql.addParam(new MQLParam("key", "The key", "string", true));
		functions.get("Node").add(mql);
		mql = new MQLDocumentation(true, "node show detailed", "To show a node with detailed information", "node show detailed \"keyId\"", "{<br>  \"dataFileId\": 0,<br>  \"dataFilePosition\": 1579520,<br>  \"data\": \"{\\\"a\\\":5.0,\\\"tab\\\":[],\\\"key\\\":\\\"keyId\\\"}\",<br>  \"size\": 32,<br>  \"indexFileTabPosition\": 5,<br>  \"key\": \"keyId\",<br>  \"indexFileToWrite\": 282<br>}", null, null, null, null, false, "");
		mql.addParam(new MQLParam("key", "The key", "string", true));
		functions.get("Node").add(mql);
		...
		functions.put("Transaction", new Vector<MQLDocumentation>());
		page_description.put("Transaction", "<img src='images/p.png' style='vertical-align: middle;'>Whenever you run MQL commands, you are in a micro transaction."+
				"<br><img src='images/p.png' style='vertical-align: middle;'>If one of your orders returns an error, all your micro transaction is rollbacked."+
				"<br><img src='images/p.png' style='vertical-align: middle;'>The storage system is ACID.");
		mql = new MQLDocumentation(true, "commit", "To commit the current transaction", "word create duck en;<br>commit;<br>word create rabbit en;<br>exception (1) (\"here a rollback ...\");", "1: here a rollback ...", "node show W[duck]", "{<br>  \"fl\": {<br>    \"en\": {<br>      \"ltl\": \"TH[77]\",<br>      \"ftl\": \"TH[77]\"<br>    }<br>  },<br>  \"w\": 1,<br>  \"k\": \"W[duck]\"<br>}", "node show W[rabbit]", "Sorry, the node 'W[rabbit]' does not exist.", false, "");
		functions.get("Transaction").add(mql);
		mql = new MQLDocumentation(true, "rollback", "To rollback the current transaction", "word create wolf en;<br>commit;<br>word create panda en;<br>rollback;", "Rollback done.", "node show W[wolf]", "{<br>  \"fl\": {<br>    \"en\": {<br>      \"ltl\": \"TH[78]\",<br>      \"ftl\": \"TH[78]\"<br>    }<br>  },<br>  \"w\": 1,<br>  \"k\": \"W[wolf]\"<br>}", "node show W[panda]", "Sorry, the node 'W[panda]' does not exist.", false, "");
		functions.get("Transaction").add(mql);
		mql = new MQLDocumentation(true, "transaction logs", "To show the log block list to replay", "word create hippo en;<br>env set var \"[transaction_logs]\" (transaction logs 10;);<br>[transaction_logs]", "[<br>  \"1\\tTO_OVERWRITE_COUNTER_INDEX\\tIndexFileId:651\\tCounter:4\",<br>  \"2\\tTO_SET_OLD_INDEX_BLOCK\\tIndexFileId:651\\tIndexPosition:104\\tDataFileId:-1\\tDataPosition:-1\",<br>  \"3\\tTO_DELETE_BLOCK\\tDataFileId:0\\tPosition:1589248\",<br>  \"4\\tTO_REWRITE_UNUSED\\tDataFileId:0\\tPosition:1589248\",<br>  \"5\\tTO_DELETE_BLOCK\\tDataFileId:0\\tPosition:1589504\",<br>  \"6\\tTO_REWRITE_UNUSED\\tDataFileId:0\\tPosition:1589504\",<br>  \"7\\tTO_OVERWRITE_COUNTER_INDEX\\tIndexFileId:651\\tCounter:5\",<br>  \"8\\tTO_SET_OLD_INDEX_BLOCK\\tIndexFileId:651\\tIndexPosition:104\\tDataFileId:0\\tDataPosition:1589504\",<br>  \"9\\tTO_DELETE_UNUSED\\tDataFileId:0\\tUnusedLength:8\",<br>  \"10\\tTO_REWRITE_BLOCK\\tDataFileId:0\\tPosition:1589504\\tNextPosition:-1\\tData:W1siV1toaXBwb10iLDAsMTU4OTI0OF1d                                                                                                                                                                                                        \\tSize:32\"<br>]", null, null, null, null, false, "");
		mql.addParam(new MQLParam("limit", "The limit value", "integer >= 0", true));
		functions.get("Transaction").add(mql);
		mql = new MQLDocumentation(true, "auto commit set", "To set the auto commit mode", "auto commit set false", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("bool", "The boolean (true|false)", "boolean", true));
		functions.get("Transaction").add(mql);
		mql = new MQLDocumentation(true, "auto commit", "To get the auto commit mode", "auto commit", "1", null, null, null, null, false, "");
		functions.get("Transaction").add(mql);
		
		functions.put("File System", new Vector<MQLDocumentation>());
		page_description.put("File System", "<img src='images/p.png' style='vertical-align: middle;'>Each of your JSON nodes are saved in blocks to form a record."+
				"<br><img src='images/p.png' style='vertical-align: middle;'>All blocks and records are searchable through position calculations in index and data files."+
				"<br><img src='images/p.png' style='vertical-align: middle;'>You can see the sizes of the data and index files at any time.");
		mql = new MQLDocumentation(true, "fs index size", "To show the size of all index files (by page)", "fs index size 1 10", "[<br>  {<br>    \"percent_used\": 6,<br>    \"current_max_block_size\": 16,<br>    \"size\": 200,<br>    \"current_block_size\": 1,<br>    \"percent_graph\": \"|-----------------------------\",<br>    \"indexFileId\": 0<br>  },<br>  {<br>    \"percent_used\": 12,<br>    \"current_max_block_size\": 16,<br>    \"size\": 200,<br>    \"current_block_size\": 2,<br>    \"percent_graph\": \"|||---------------------------\",<br>    \"indexFileId\": 1<br>  },<br>  {<br>    \"percent_used\": 31,<br>    \"current_max_block_size\": 16,<br>    \"size\": 200,<br>    \"current_block_size\": 5,<br>    \"percent_graph\": \"|||||||||---------------------\",<br>    \"indexFileId\": 2<br>  },<br>  {<br>    \"percent_used\": 25,<br>    \"current_max_block_size\": 16,<br>    \"size\": 200,<br>    \"current_block_size\": 4,<br>    \"percent_graph\": \"|||||||-----------------------\",<br>    \"indexFileId\": 3<br>  },<br>  {<br>    \"percent_used\": 37,<br>    \"current_max_block_size\": 16,<br>    \"size\": 200,<br>    \"current_block_size\": 6,<br>    \"percent_graph\": \"|||||||||||-------------------\",<br>    \"indexFileId\": 4<br>  },<br>  {<br>    \"percent_used\": 0,<br>    \"current_max_block_size\": 16,<br>    \"size\": 200,<br>    \"current_block_size\": 0,<br>    \"percent_graph\": \"------------------------------\",<br>    \"indexFileId\": 5<br>  },<br>  {<br>    \"percent_used\": 0,<br>    \"current_max_block_size\": 16,<br>    \"size\": 200,<br>    \"current_block_size\": 0,<br>    \"percent_graph\": \"------------------------------\",<br>    \"indexFileId\": 6<br>  },<br>  {<br>    \"percent_used\": 6,<br>    \"current_max_block_size\": 16,<br>    \"size\": 200,<br>    \"current_block_size\": 1,<br>    \"percent_graph\": \"|-----------------------------\",<br>    \"indexFileId\": 7<br>  },<br>  {<br>    \"percent_used\": 12,<br>    \"current_max_block_size\": 16,<br>    \"size\": 200,<br>    \"current_block_size\": 2,<br>    \"percent_graph\": \"|||---------------------------\",<br>    \"indexFileId\": 8<br>  },<br>  {<br>    \"percent_used\": 25,<br>    \"current_max_block_size\": 16,<br>    \"size\": 200,<br>    \"current_block_size\": 4,<br>    \"percent_graph\": \"|||||||-----------------------\",<br>    \"indexFileId\": 9<br>  }<br>]", "metric index files 1 10;", "Total block: 1000x16=16000<br>Total size: 1000x200=200000b<br>|----------------------------- 6% - 0 - used: 1, free: 15, total block: 16, size: 200b<br>|||--------------------------- 12% - 1 - used: 2, free: 14, total block: 16, size: 200b<br>|||||||||--------------------- 31% - 2 - used: 5, free: 11, total block: 16, size: 200b<br>|||||||----------------------- 25% - 3 - used: 4, free: 12, total block: 16, size: 200b<br>|||||||||||------------------- 37% - 4 - used: 6, free: 10, total block: 16, size: 200b<br>------------------------------ 0% - 5 - used: 0, free: 16, total block: 16, size: 200b<br>------------------------------ 0% - 6 - used: 0, free: 16, total block: 16, size: 200b<br>|----------------------------- 6% - 7 - used: 1, free: 15, total block: 16, size: 200b<br>|||--------------------------- 12% - 8 - used: 2, free: 14, total block: 16, size: 200b<br>|||||||----------------------- 25% - 9 - used: 4, free: 12, total block: 16, size: 200b<br>", null, null, false, "");
		mql.addParam(new MQLParam("page", "The page", "integer >= 1", true));
		mql.addParam(new MQLParam("nbByPage", "The number by page", "integer>0", true));
		functions.get("File System").add(mql);
		mql = new MQLDocumentation(true, "fs data size", "To show the size of all data files in a page", "fs data size 1 2", "[<br>  {<br>    \"dataFileId\": 0,<br>    \"percent_used\": 0,<br>    \"current_max_block_size\": 10000000,<br>    \"size\": 1583616,<br>    \"current_block_size\": 6186,<br>    \"nbUnusedBlock\": 22,<br>    \"percent_graph\": \"------------------------------\",<br>    \"lastUnusedBlock\": 1577216<br>  }<br>]", "metric data files 1 2;", "------------------------------ 0% - 0 - used: 6186, free: 9993814, total block: 10000000, size: 1583616b, max size: 2560Mb, last unused block: 1577216, nb unused block: 22", null, null, false, "");
		mql.addParam(new MQLParam("page", "The page", "integer >= 1", true));
		mql.addParam(new MQLParam("nbByPage", "The number by page", "integer>0", true));
		functions.get("File System").add(mql);
		mql = new MQLDocumentation(true, "fs index calcul pos", "To calculate the index position for a specific key", "fs index calcul pos \"W[cat]\"", "{<br>  \"indexPosition\": 8,<br>  \"key\": \"W[cat]\",<br>  \"indexFileId\": 115<br>}", null, null, null, null, false, "");
		mql.addParam(new MQLParam("key", "The key", "string", true));
		functions.get("File System").add(mql);
		mql = new MQLDocumentation(true, "fs index block", "To show a specific block at a position in an index file (The first 8 bytes is the number of block from the index file)", "fs index block 115 8", "{<br>  \"DataFileId\": 0,<br>  \"DataPosition\": 1575168<br>}", null, null, null, null, false, "");
		mql.addParam(new MQLParam("indexFileId", "The index file id", "integer >= 0", true));
		mql.addParam(new MQLParam("position", "The position", "integer >= 0", true));
		functions.get("File System").add(mql);
		mql = new MQLDocumentation(true, "fs index count", "To show the number of block from an index file", "fs index count 115", "2", null, null, null, null, false, "");
		mql.addParam(new MQLParam("indexFileId", "The index file id", "integer >= 0", true));
		functions.get("File System").add(mql);
		mql = new MQLDocumentation(true, "fs data block", "To show a specific block at a position from a data file", "#Here the collision block;<br>fs data block 0 1575168", "{<br>  \"nextBlockAddress\": -1,<br>  \"data\": \"W1siV1tjYXRdIiwwLDE1NzU0MjRdXQ\\u003d\\u003d\"<br>}", null, null, null, null, false, "");
		mql.addParam(new MQLParam("dataFileId", "The data file id", "integer >= 0", true));
		mql.addParam(new MQLParam("position", "The position", "integer >= 0", true));
		functions.get("File System").add(mql);
		mql = new MQLDocumentation(true, "fs data record", "To show all blocks in a record at the position in a data file", "#Here the collision record;<br>fs data record 0 1575168", "[<br>  {<br>    \"blockId\": 1,<br>    \"block\": {<br>      \"nextBlockAddress\": -1,<br>      \"data\": \"W1siV1tjYXRdIiwwLDE1NzU0MjRdXQ\\u003d\\u003d\"<br>    },<br>    \"position\": 1575168<br>  },<br>  \"[[\\\"W[cat]\\\",0,1575424]]\"<br>]", "#Here the data record W[cat];<br>fs data record 0 1575424", "[<br>  {<br>    \"blockId\": 1,<br>    \"block\": {<br>      \"nextBlockAddress\": -1,<br>      \"data\": \"eyJmbCI6eyJlbiI6eyJsdGwiOiJUSFs2dF0iLCJmdGwiOiJUSFs2dF0ifX0sInciOjIsImsiOiJXW2NhdF0ifQ\\u003d\\u003d\"<br>    },<br>    \"position\": 1575424<br>  },<br>  \"{\\\"fl\\\":{\\\"en\\\":{\\\"ltl\\\":\\\"TH[6t]\\\",\\\"ftl\\\":\\\"TH[6t]\\\"}},\\\"w\\\":2,\\\"k\\\":\\\"W[cat]\\\"}\"<br>]", "#Here the data node W[cat];<br>node show W[cat]", "{<br>  \"fl\": {<br>    \"en\": {<br>      \"ltl\": \"TH[72]\",<br>      \"ftl\": \"TH[6t]\"<br>    }<br>  },<br>  \"w\": 10,<br>  \"k\": \"W[cat]\"<br>}", false, "");
		mql.addParam(new MQLParam("dataFileId", "The data file id", "integer >= 0", true));
		mql.addParam(new MQLParam("position", "The position", "integer >= 0", true));
		functions.get("File System").add(mql);
		mql = new MQLDocumentation(true, "fs cache size", "To show the cache size", "fs cache size", "512", null, null, null, null, false, "");
		functions.get("File System").add(mql);
		mql = new MQLDocumentation(true, "fs lock size", "To show the lock size", "fs lock size", "21", null, null, null, null, false, "");
		functions.get("File System").add(mql);
		mql = new MQLDocumentation(true, "fs unused data block", "To show the unused block list (after a block was deleted). The list return the last block before.", "fs unused data block 0 10", "[<br>  1577728,<br>  1578752,<br>  1579008,<br>  57344,<br>  1579520,<br>  1579776,<br>  1581312,<br>  1580288,<br>  1580032,<br>  1579264,<br>  1581824<br>]", null, null, null, null, false, "");
		mql.addParam(new MQLParam("dataFileId", "The data file id", "integer >= 0", true));
		mql.addParam(new MQLParam("limit", "The limit", "integer >= 0", true));
		functions.get("File System").add(mql);
		mql = new MQLDocumentation(true, "fs unused nb block", "To show the number of unused data block (after a block was deleted)", "fs unused nb block 0", "22", null, null, null, null, false, "");
		mql.addParam(new MQLParam("dataFileId", "The data file id", "integer >= 0", true));
		functions.get("File System").add(mql);
		mql = new MQLDocumentation(true, "fs unused last block", "To show the last unused data block (after a block was deleted)", "fs unused last block 0", "1577728", null, null, null, null, false, "");
		mql.addParam(new MQLParam("dataFileId", "The data file id", "integer >= 0", true));
		functions.get("File System").add(mql);
		...
		mql = new MQLDocumentation(true, "metric index files", "To show all stats about index files", "metric index files 1 2", "Total block: 1000x16=16000<br>Total size: 1000x200=200000b<br>|----------------------------- 6% - 0 - used: 1, free: 15, total block: 16, size: 200b<br>------------------------------ 0% - 1 - used: 0, free: 16, total block: 16, size: 200b", null, null, null, null, false, "");
		mql.addParam(new MQLParam("page", "The page", "integer>0", true));
		mql.addParam(new MQLParam("nbByPage", "The number by page", "integer>0", true));
		functions.get("Metric").add(mql);
		mql = new MQLDocumentation(true, "metric data files", "To show all stats about data files", "metric data files 1 2", "------------------------------ 0% - 0 - used: 3699, free: 9996301, total block: 10000000, size: 458676b, max size: 1240Mb, last unused block: -1, nb unused block: 0", null, null, null, null, false, "");
		mql.addParam(new MQLParam("page", "The page", "integer>0", true));
		mql.addParam(new MQLParam("nbByPage", "The number by page", "integer>0", true));
		functions.get("Metric").add(mql);
		...
		functions.get("Session").add(new MQLDocumentation(true, "cmdid", "To show the number of command executed by the current user", "cmdid", "25", null, null, null, null, false, ""));
		...
		mql = new MQLDocumentation(true, "parameter add", "To add a new parameter", "parameter add test value 0", "Parameter added with successful.", null, null, null, null, false, "parameter create|insert|add");
		mql.addParam(new MQLParam("key", "The key", "string", true));
		mql.addParam(new MQLParam("value", "The value", "integer", true));
		mql.addParam(new MQLParam("locked", "The field is locked", "boolean (1 or 0)", true));
		functions.get("Parameter").add(mql);
		mql = new MQLDocumentation(true, "parameter merge", "To merge a parameter", "parameter merge test value 0", "Parameter merged with successful.", null, null, null, null, false, "");
		mql.addParam(new MQLParam("key", "The key", "string", true));
		mql.addParam(new MQLParam("value", "The value", "integer", true));
		mql.addParam(new MQLParam("locked", "The field is locked", "boolean (1 or 0)", true));
		functions.get("Parameter").add(mql);
		...
		mql.addParam(new MQLParam("key", "The key", "string", true));
		functions.get("Parameter").add(mql);
		mql = new MQLDocumentation(true, "parameter get locked_dml", "To get the parameter locked dml status", "parameter get locked_dml test", "0", null, null, null, null, false, "");
		mql.addParam(new MQLParam("key", "The key", "string", true));
		functions.get("Parameter").add(mql);
		mql = new MQLDocumentation(true, "parameter lock_dml", "To lock a parameter", "parameter lock_dml test", "Parameter locked for dml with successful.", null, null, null, null, false, "");
		mql.addParam(new MQLParam("key", "The key", "string", true));
		functions.get("Parameter").add(mql);
		...
		functions.get("Parameter").add(mql);
		mql = new MQLDocumentation(true, "parameter unlock_dml", "To unlock for DML a parameter", "parameter unlock_dml test", "Parameter unlocked for dml with successful.", null, null, null, null, false, "");
		mql.addParam(new MQLParam("key", "The key", "string", true));
		functions.get("Parameter").add(mql);
		...
		functions.get("Server").add(mql);
		functions.get("Server").add(new MQLDocumentation(true, "in editor", "To refresh the tree in the editor", "in editor {script generate update \"division\"}", "...", null, null, null, null, false, ""));
