...
public class Doc_structure {
	...
	public static void load() {
		...
		structure += "<p>We are, in a way, a super self-programmable mental process manager, linked to an emotion manager, above a totally symbolic storage structure (allowing cognitive fast restitution).</p>";
