...
public class Doc_Mentalese_Application {
	...
	public static void init(LinkedHashMap<String, Vector<MQLDocumentation>> functions,
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_create_remote_script", "To create a remote valid script", "script create exe \"script.var.show\" false 1\n" + 
				"  (param\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_skeleton_custom_html", "To add custom HTML", "concat_var \"[page]\" \"<div></div>\";", "html", null, null, null, null, false, ""));
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_skeleton_container", "To show a Bootstrap container object", "include \"app.100.obj.sajax.skeleton.container.exe\" \"[id]\" \"\" \"[name]\" \"\" \"[class]\" \"\" \"[style]\" \"\";\n" + 
				"		\n" + 
				"	include \"app.100.obj.sajax.skeleton.div.end.exe\";", "html", null, null, null, null, false, ""));
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_skeleton_row", "To show a Bootstrap row object", "include \"app.100.obj.sajax.skeleton.row.exe\" \"[id]\" \"\" \"[name]\" \"\" \"[class]\" \"\" \"[style]\" \"\";\n" + 
				"			\n" + 
				"		include \"app.100.obj.sajax.skeleton.div.end.exe\";", "html", null, null, null, null, false, ""));
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_skeleton_col", "To show a Bootstrap col object", "include \"app.100.obj.sajax.skeleton.col.exe\" \"[id]\" \"container_id_1\" \"[name]\" \"\" \"[class]\" \"col-12 col-xs-12 col-sm-12 col-md-12 col-lg-12\" \"[style]\" \"\"; include \"app.100.obj.sajax.skeleton.div.end.exe\";", "html", null, null, null, null, false, ""));
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_skeleton_onload_mql", "To execute a MQL source code before loading the page", "include \"app.100.obj.sajax.skeleton.onload.exe\"\n" + 
				"		\"[scriptname]\" \"script.var.show.exe\"\n" + 
				"		\"[OBJ_OVERWRITE_B64]\" (string encode_b64 \"{\\\"v1\\\": 1, \\\"v2\\\": 2}\")\n" + 
				"	;", "html", null, null, null, null, false, ""));
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_skeleton_get_javascript_to_execute_mql", "To get a javascript source code to execute a MQL remote script", "concat_var \"[page]\" \"<div><button onclick=\" (include \"app.100.obj.sajax.client.exe\" \n" + 
				"		\"[scriptname]\" \"script.var.show.exe\" \n" + 
				"		\"[OBJ_OVERWRITE_B64]\" (string encode_b64 \"{\\\"v1\\\": 1, \\\"v2\\\": 2}\") \n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_skeleton_all_charts", "To get skeleton for all charts", "include \"app.100.obj.sajax.skeleton.container.exe\" \"[id]\" \"\" \"[name]\" \"\" \"[class]\" \"\" \"[style]\" \"\";\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_show_button", "To add a button into a container", "include \"app.100.obj.sajax.button.exe\"\n" + 
				...
				"	;", "html", null, null, null, null, false, ""));
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_refresh_container", "To refresh a container with a HTML source code", "include \"app.100.obj.sajax.refresh.exe\"\n" + 
				"		\"[target]\" \"container_id_1\"\n" + 
				"		\"[innerHtml]\" \"<div style='background-color:#313131;color:#fff'>Hello!</div>\"\n" + 
				"	;", "html", null, null, null, null, false, ""));
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_show_alert", "To show an alert", "include \"app.100.obj.sajax.alert.exe\"\n" + 
				"		\"[type]\" \"ALERT_PRIMARY|ALERT_SECONDARY|ALERT_SUCCESS|ALERT_DANGER|ALERT_WARNING|ALERT_INFO|ALERT_LIGHT|ALERT_DARK\"\n" + 
				"		\"[strong]\" \"OK !\"\n" + 
				"		\"[msg]\" \"Message\"\n" + 
				"	;", "html", null, null, null, null, false, ""));
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_execute_javascript", "To execute a javascript source code", "include \"app.100.obj.sajax.javascript.exe\"\n" + 
				"		\"[javascript]\" \"alert('test');\"\n" + 
				"	;", "html", null, null, null, null, false, ""));
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_get_javascript_to_execute_mql", "To get a javascript source code to execute a MQL remote script", "include \"app.100.obj.sajax.refresh.exe\"\n" + 
				"		\"[target]\" \"container_id_1\"\n" + 
				...
				"		) \">execute me</button>\")\n" + 
				"	;", "html", null, null, null, null, false, ""));
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_all_chart", "To get all charts", "include \"app.100.obj.kpi.exe\" \"[container_id]\" \"kpi\";\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form", "To show a form", "-> \"[object]\" \"\";\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_text", "To show a textbox (text type)", "	include \"app.100.obj.form.control.textbox.text.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Text\" \"[description]\" \"\" \"[maxlength]\" \"255\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_range", "To show a textbox (range type)", "	include \"app.100.obj.form.control.textbox.range.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_number", "To show a textbox (number type)", "	include \"app.100.obj.form.control.textbox.number.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_mail", "To show a textbox (mail type)", "	include \"app.100.obj.form.control.textbox.mail.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Mail\" \"[description]\" \"\" \"[maxlength]\" \"255\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_tel", "To show a textbox (tel type)", "	include \"app.100.obj.form.control.textbox.tel.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Tel\" \"[description]\" \"\" \"[maxlength]\" \"255\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_time", "To show a textbox (time type)", "	include \"app.100.obj.form.control.textbox.time.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Time\" \"[description]\" \"\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_date_fr", "To show a textbox (date_fr type)", "	include \"app.100.obj.form.control.textbox.date_fr.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Date fr\" \"[description]\" \"\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_date_en", "To show a textbox (date_en type)", "	include \"app.100.obj.form.control.textbox.date_en.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Date en\" \"[description]\" \"\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_datetime_fr", "To show a textbox (datetime_fr type)", "	include \"app.100.obj.form.control.textbox.datetime_fr.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Datetime fr\" \"[description]\" \"\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_datetime_en", "To show a textbox (datetime_en type)", "	include \"app.100.obj.form.control.textbox.datetime_en.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Datetime en\" \"[description]\" \"\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_color", "To show a textbox (color type)", "	include \"app.100.obj.form.control.textbox.color.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Color\" \"[description]\" \"\" \"[maxlength]\" \"255\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_password", "To show a textbox (password type)", "	include \"app.100.obj.form.control.textbox.password.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Password\" \"[description]\" \"\" \"[maxlength]\" \"255\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textbox_file", "To show a textbox (file type)", "	include \"app.100.obj.form.control.textbox.file.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"File\" \"[description]\" \"\" \"[maxlength]\" \"255\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textarea", "To show a textarea", "	include \"app.100.obj.form.control.textarea.exe\" \"[control_id]\" \"control_14\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Textarea\" \"[description]\" \"\" \"[maxlength]\" \"255\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_textarea_ckeditor", "To show a textarea", "	include \"app.100.obj.form.control.textarea_cke.exe\" \"[control_id]\" \"control_14\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
				"		\"[label]\" \"Textarea\" \"[description]\" \"\" \"[maxlength]\" \"255\" \"[placeholder]\" \"\"\n" + 
				"		\"[readonly]\" false \"[required]\" false \"[disabled]\" false \"[html]\" \"\"\n" + 
				"		\"[value]\" \"\"\n" + 
				"	;", "html", null, null, null, null, false, ""));

		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_select_mono", "To show a select mono", "	include \"app.100.obj.form.control.select_mono.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_select_multiple", "To show a select multiple", "	include \"app.100.obj.form.control.select_multiple.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_radio_line", "To show a radio line", "	include \"app.100.obj.form.control.radio_line.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_radio_inline", "To show a radio inline", "	include \"app.100.obj.form.control.radio_inline.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_checkbox_line", "To show a checkbox line", "	include \"app.100.obj.form.control.checkbox_line.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_checkbox_inline", "To show a checkbox inline", "	include \"app.100.obj.form.control.checkbox_inline.exe\" \"[control_id]\" \"control_1\" \"[class]\" \"col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12\"\n" + 
		...
		functions.get("App").add(new MQLDocumentation(true, "_app_sajax_in_loading_form_control_hidden", "To add a hidden", "	include \"app.100.obj.form.control.hidden.exe\"\n" + 
