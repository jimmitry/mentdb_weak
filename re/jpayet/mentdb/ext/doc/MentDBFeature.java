...
public static String to_html() {
	...
	public static void init() throws Exception {
		...
		features.get("SERVER").add(new MentDBFeature("A.C.I.D. File System", "[OK]", "[KO] I can forget everything after a stroke", 100));
		...
		features.get("SERVER").add(new MentDBFeature("Transaction", "[OK]", "[KO]", 100));
