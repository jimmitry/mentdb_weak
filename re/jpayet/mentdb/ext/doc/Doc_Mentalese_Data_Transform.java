...
public class Doc_Mentalese_Data_Transform {
	...
	public static void init(LinkedHashMap<String, Vector<MQLDocumentation>> functions,
		...
		mql.addParam(new MQLParam("number", "The number to add", "Number", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date datediff", "sub a number to a date.\n", "date datediff \"1980-06-18\" \"DAY\" 1", "1980-06-17", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		mql.addParam(new MQLParam("field", "The field to add (DAY|MONTH|YEAR)", "String", true));
		mql.addParam(new MQLParam("number", "The number to add", "Number", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date datedifft", "sub a number to a date.\n", "date datedifft \"1980-06-18 00:00:00\" \"DAY\" 1", "1980-06-17 00:00:00", null, null, null, null, false, "");
		mql.addParam(new MQLParam("timestamp", "The timestamp", "String", true));
		mql.addParam(new MQLParam("field", "The field to add (SEC|MIN|HOUR|DAY|MONTH|YEAR)", "String", true));
		mql.addParam(new MQLParam("number", "The number to add", "Number", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date ts_to_long", "timestamp to long.\n", "date ts_to_long \"1980-06-18 00:00:00\"", "330120000000", null, null, null, null, false, "");
		mql.addParam(new MQLParam("timestamp", "The timestamp", "String", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date dt_to_long", "date to long.\n", "date dt_to_long \"1980-06-18\"", "330120000000", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date long_to_dt", "long to date.\n", "date long_to_dt \"330120000000\"", "1980-06-18", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date long_to_ts", "long to timestamp.\n", "date long_to_ts \"330120000000\"", "1980-06-18 00:00:00", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date day_of_month", "get the day of month of a date.\n", "date day_of_month \"1980-06-18\"", "18", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date day_of_week", "get the day of week of a date.\n", "date day_of_week \"1980-06-18\"", "3", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date day_of_year", "get the day of year of a date.\n", "date day_of_year \"1980-06-18\"", "170", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date dayname", "get the day name of a date.\n", "date dayname \"1980-06-18\"", "mercredi", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date diff", "sub a number to a date.\n", "date diff \"1980-06-18\" \"DAY\" 1", "1980-06-17", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		mql.addParam(new MQLParam("field", "The field to add (DAY|MONTH|YEAR)", "String", true));
		mql.addParam(new MQLParam("number", "The number to add", "Number", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date difft", "sub a number to a time stamp.\n", "date difft \"1980-06-18 00:00:00\" \"DAY\" 1", "1980-06-17 00:00:00", null, null, null, null, false, "");
		mql.addParam(new MQLParam("timestamp", "The timestamp", "String", true));
		mql.addParam(new MQLParam("field", "The field to add (SEC|MIN|HOUR|DAY|MONTH|YEAR)", "String", true));
		mql.addParam(new MQLParam("number", "The number to add", "Number", true));
		functions.get("Date").add(mql);
		...
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date hour", "get the hour of a time.\n", "date hour \"12:15:56\"", "12", null, null, null, null, false, "");
		...
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date minute", "get the minute of a time.\n", "date minute \"12:15:56\"", "15", null, null, null, null, false, "");
		mql.addParam(new MQLParam("time", "The time", "String", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date month", "get the month of a date.\n", "date month \"1980-06-18\"", "6", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date monthname", "get the month name of a date.\n", "date monthname \"1980-06-18\"", "juin", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		functions.get("Date").add(mql);
		...
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date seconde", "get the seconde of a time.\n", "date seconde \"12:15:56\"", "56", null, null, null, null, false, "");
		mql.addParam(new MQLParam("time", "The time", "String", true));
		functions.get("Date").add(mql);
		...
		mql.addParam(new MQLParam("timestamp", "The timestamp", "String", true));
		functions.get("Date").add(mql);
		mql = new MQLDocumentation(true, "date year", "get the year of a date.\n", "date year \"1980-06-18\"", "1980", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		functions.get("Date").add(mql);
		...
		mql = new MQLDocumentation(true, "math acos", "get the arc cosine of a number\n", "math acos 42", "NaN", null, null, null, null, false, "");
		mql.addParam(new MQLParam("number", "A number", "Number", true));
		functions.get("Math").add(mql);
		mql = new MQLDocumentation(true, "math asin", "get the arc sine of a number\n", "math asin 0.5", "0.5235987755982989", null, null, null, null, false, "");
		mql.addParam(new MQLParam("number", "A number", "Number", true));
		functions.get("Math").add(mql);
		...
		functions.get("Math").add(mql);
		mql = new MQLDocumentation(true, "math bit_and", "the bitwise and operation\n", "math bit_and 4456 234", "104", null, null, null, null, false, "");
		mql.addParam(new MQLParam("number1", "A number", "Number", true));
		mql.addParam(new MQLParam("number2", "A number", "Number", true));
		functions.get("Math").add(mql);
		...
		mql.addParam(new MQLParam("number", "A number", "Number", true));
		functions.get("Math").add(mql);
		mql = new MQLDocumentation(true, "math max", "returns the greater\n", "math max 4456 234", "4456", null, null, null, null, false, "");
		mql.addParam(new MQLParam("number1", "A number", "Number", true));
		mql.addParam(new MQLParam("number2", "A number", "Number", true));
		functions.get("Math").add(mql);
		mql = new MQLDocumentation(true, "math min", "returns the smaller of two int values\n", "math min 4456 234", "234", null, null, null, null, false, "");
		mql.addParam(new MQLParam("number1", "A number", "Number", true));
		mql.addParam(new MQLParam("number2", "A number", "Number", true));
		functions.get("Math").add(mql);
		mql = new MQLDocumentation(true, "math mod", "the modulo operation\n", "math mod 4456 234", "10", null, null, null, null, false, "");
		mql.addParam(new MQLParam("number1", "A number", "Number", true));
		mql.addParam(new MQLParam("number2", "A number", "Number", true));
		functions.get("Math").add(mql);
		mql = new MQLDocumentation(true, "math pi", "get pi value\n", "math pi", "3.141592653589793", null, null, null, null, false, "");
		functions.get("Math").add(mql);
		mql = new MQLDocumentation(true, "math pow", " get the value of a number raised to the power of another number\n", "math pow 0.5 7", "0.0078125", null, null, null, null, false, "");
		mql.addParam(new MQLParam("number1", "A number", "Number", true));
		mql.addParam(new MQLParam("number2", "A number", "Number", true));
		functions.get("Math").add(mql);
		mql = new MQLDocumentation(true, "math power", " get the value of a number raised to the power of another number<br>", "math power 0.5 7", "0.0078125", null, null, null, null, false, "");
		mql.addParam(new MQLParam("number1", "A number", "Number", true));
		mql.addParam(new MQLParam("number2", "A number", "Number", true));
		functions.get("Math").add(mql);
		...
		mql.addParam(new MQLParam("number", "A number", "Number", true));
		functions.get("Math").add(mql);
		mql = new MQLDocumentation(true, "math random", "get the random number between 0 and the argument<br>", "math random 42", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("number", "A number", "Number", true));
		functions.get("Math").add(mql);
		...
		mql.addParam(new MQLParam("number", "A number", "Number", true));
		functions.get("Math").add(mql);
		mql = new MQLDocumentation(true, "math round", "rounds a number specified as an argument up to a number specified as another argument<br>", "math round 1.23654 2", "1.24", null, null, null, null, false, "");
		mql.addParam(new MQLParam("number1", "A number", "Number", true));
		mql.addParam(new MQLParam("number2", "A number", "Number", true));
		functions.get("Math").add(mql);
		...
		mql.addParam(new MQLParam("number", "A number", "Number", true));
		functions.get("Math").add(mql);
		mql = new MQLDocumentation(true, "math signum", "get the sign of a number<br>", "math signum 42", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("number", "A number", "Number", true));
		functions.get("Math").add(mql);
		...
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string char", "convert an integer to character<br>", "string char 97", "a", null, null, null, null, false, "");
		mql.addParam(new MQLParam("num", "The number", "Number", true));
		functions.get("String").add(mql);
		...
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string char_to_int", "convert a character to integer<br>", "string char_to_int \"a\"", "97", null, null, null, null, false, "");
		mql.addParam(new MQLParam("chr", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "concat", "concat all parameters (do not use this function with string. before)<br>", "concat 97 \"a\" \"r\"", "97ar", null, null, null, null, false, "");
		...
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string sentences_distance", "To get the sentence distance between sentences", "string sentences_distance 40 70 \"vrai passionné\" \"{\n" + 
				"	\\\"1\\\": {\n" + 
		...
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string levenshtein_distance", "To get the levenshtein distance between two words", "string levenshtein_distance \"admn\" \"admin\"", "1", null, null, null, null, false, "");
		...
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string count", "count the occurrence number of a string in another string<br>", "string count \"azertyaze\" \"a\"", "2", null, null, null, null, false, "");
		...
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string decode_sign_verify", "Chech a text with a signature and a public key<br>", "string decode_sign_verify \"azerty\" \"MD0CHCGD3SEzr5rIZnSdnyT+DGLPqHbI9VFBjwY3yv0CHQCfA56aUbe0y/ixaXgx7GWXM/JFAYAXnU3uFP/l\" (json select \"keyId\" \"/publicKey\")", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("data", "The data string", "String", true));
		...
		mql.addParam(new MQLParam("mql", "The mql source code", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string ends_with", "check if a value ends with another string<br>", "string ends_with \"azertyaze\" 3", "0", null, null, null, null, false, "");
		...
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string first_letter_upper", "returns the string in lower case. the first letter in upper case.<br>", "string first_letter_upper \"azerty\"", "Azerty", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		...
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string generate_random_str", "generate a random string<br>", "string generate_random_str 1", "D", null, null, null, null, false, "");
		mql.addParam(new MQLParam("size", "The size of the string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string hex", "returns a string representation of the hexadecimal value of n, where n is a long (bigint) number<br>", "string hex 97", "61", null, null, null, null, false, "");
		mql.addParam(new MQLParam("num", "The number", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string hex_to_int", "convert a hexadecimal number to (bigint) number<br>", "string hex_to_int 97", "151", null, null, null, null, false, "");
		mql.addParam(new MQLParam("hex", "The hex number", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string hex_to_str", "get a string from a hexadecimal representation (ascii).<br>", "string hex_to_str 61", "a", null, null, null, null, false, "");
		...
		mql.addParam(new MQLParam("num", "The number", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string int_to_hex", "returns a string representation of the hexadecimal value of n, where n is a long (bigint) number<br>", "string int_to_hex 97", "61", null, null, null, null, false, "");
		mql.addParam(new MQLParam("num", "The number", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string int_to_oct", "returns a string representation of the octal value of n, where n is a long (bigint) number<br>", "string int_to_oct 97", "141", null, null, null, null, false, "");
		mql.addParam(new MQLParam("num", "The number", "Number", true));
		functions.get("String").add(mql);
		...
		mql.addParam(new MQLParam("value", "The value", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string itrim", "returns the string with one space character between other chars<br>", "string itrim \"aze   rty\"", "aze rty", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		...
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string left", "get the leftmost len characters from the string str.<br>", "string left \"AZERTY\" 3", "AZE", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		...
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string ltrim", "returns the string without space character on the left<br>", "string ltrim \"  azerty   \"", "azerty&nbsp;&nbsp;&nbsp;", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string matches", "performs a pattern match of a string expression expr against a pattern pat<br>", "string matches \"azerty\" \".*ze.*\"", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "the string", "String", true));
		mql.addParam(new MQLParam("pat", "the paterne", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string mid", "returns a new string that is a substring of this string. the substring begins with the character at the specified index and extends to the end of this string.<br>", "string mid \"azertyaze\" 3", "rtyaze", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		mql.addParam(new MQLParam("index", "The begin of the sub string", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string mid", "returns a new string that is a substring of this string. the substring begins at the specified beginindex and extends to the character at index endindex - 1. thus the length of the substring is endindex-beginindex<br>", "string mid \"azertyaze\" 3 5", "rt", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		...
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string not_like", "not performs a pattern match of a string expression expr against a pattern pat<br>", "string not_like \"azerty\" \".*ze.*\"", "0", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "the string", "String", true));
		mql.addParam(new MQLParam("pat", "the paterne", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string not_regexp", "not performs a pattern match of a string expression expr against a pattern pat<br>", "string not_regexp \"azerty\" \".*ze.*\"", "0", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "the string", "String", true));
		mql.addParam(new MQLParam("pat", "the paterne", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string oct", "returns a string representation of the octal value of n, where n is a long (bigint) number<br>", "string oct 97", "141", null, null, null, null, false, "");
		mql.addParam(new MQLParam("num", "The number", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string oct_to_int", "convert a octal number to (bigint) number<br>", "string oct_to_int \"15\"", "13", null, null, null, null, false, "");
		mql.addParam(new MQLParam("oct", "The octal number", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string position", "returns the index within this string of the first occurrence of the specified substring<br>", "string position \"azerty\" \"r\"", "3", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str1", "The string", "String", true));
		mql.addParam(new MQLParam("str2", "The string", "String", true));
		functions.get("String").add(mql);
		...
		mql.addParam(new MQLParam("fromIndex", "starting to index", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string regexp", "performs a pattern match of a string expression expr against a pattern pat<br>", "string regexp \"azerty\" \".*ze.*\"", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "the string", "String", true));
		mql.addParam(new MQLParam("pat", "the paterne", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string repeat", "returns a string consisting of the string str repeated count times<br>", "string repeat \"AZERTY\" 3", "AZERTYAZERTYAZERTY", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		mql.addParam(new MQLParam("count", "The count number", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string repeat_insert_str", "returns a string with a string inserted all n char<br>", "string repeat_insert_str \"azertyuiop\" \"-\" 3", "aze-rty-uio-p-", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		...
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string replace", "replaces each substring of this string that matches the literal target sequence with the specified literal replacement sequence<br>", "string replace \"azerty\" \"z\" 9", "a9erty", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		...
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string reverse", "returns the string str with the order of the characters reversed.<br>", "string reverse \"AZERTY\"", "YTREZA", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string right", "get the rightmost len characters from the string str.<br>", "string right \"AZERTY\" 3", "RTY", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		mql.addParam(new MQLParam("len", "The length", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string rpad", "pads the right-side of a string with a specific set of characters<br>", "string rpad \"azertyaze\" \"#\" 10", "azertyaze#", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		mql.addParam(new MQLParam("padString", "The pad string", "String", true));
		mql.addParam(new MQLParam("paddedLength", "The end of the sub string", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string rtrim", "returns the string without space character on the right<br>", "string rtrim \"  azerty   \"", "&nbsp;&nbsp;azerty", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string space", "returns a string consisting of n space characters<br>", "string space \"5\"", "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;", null, null, null, null, false, "");
		mql.addParam(new MQLParam("count", "The number of space", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string split", "Split a string", "string split \"a b c\" \" \" -1", "[\"a\",\"b\",\"c\"]", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		mql.addParam(new MQLParam("regex", "The regex", "String", true));
		mql.addParam(new MQLParam("limit", "The limit", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string split_mql", "Split a MQL source code", "string split_mql \"a b c\" 1", "b", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		mql.addParam(new MQLParam("index", "The index position", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string split_sentence", "Split a sentence", "string split_sentence \"bonjour, comment sa vas ? Bye.\" \",?.\"", "...", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		mql.addParam(new MQLParam("chars", "The chars separator", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string starts_with", "check if a value starts with another string<br>", "string starts_with \"azertyaze\" 3", "0", null, null, null, null, false, "");
		mql.addParam(new MQLParam("stringValue", "The string", "String", true));
		mql.addParam(new MQLParam("stringToStart", "The start string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string starts_with_or", "check if a value starts with another string<br>", "string starts_with_or \"azertyaze\" aeiou", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("stringValue", "The string", "String", true));
		mql.addParam(new MQLParam("stringToStart", "The start string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string str_to_hex", "get a hexadecimal string representation of str where each character in str is converted to two hexadecimal digits.<br>", "string str_to_hex 97", "3937", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string strcmp", "compare two string<br>", "string strcmp \"AZERTY\" \"iop\"", "-40", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str1", "The string 1", "String", true));
		mql.addParam(new MQLParam("str2", "The string 2", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string strpos", "returns the index within this string of the first occurrence of the specified substring<br>", "string strpos \"azerty\" \"r\"", "3", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str1", "The string", "String", true));
		mql.addParam(new MQLParam("str2", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string strpos", "returns the index within this string of the first occurrence of the specified substring, starting at the specified index<br>", "string strpos \"azerty\" \"r\" 4", "-1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str1", "The string", "String", true));
		mql.addParam(new MQLParam("str2", "The string", "String", true));
		mql.addParam(new MQLParam("fromIndex", "starting to index", "Number", true));
		functions.get("String").add(mql);
		...
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string substr", "returns a new string that is a substring of this string. the substring begins with the character at the specified index and extends to the end of this string.<br>", "string substr \"azertyaze\" 3", "rtyaze", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		mql.addParam(new MQLParam("index", "The begin of the sub string", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string substr", "returns a new string that is a substring of this string. the substring begins at the specified beginindex and extends to the character at index endindex - 1. thus the length of the substring is endindex-beginindex<br>", "string substr \"azertyaze\" 3 5", "rt", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		mql.addParam(new MQLParam("beginIndex", "The begin of the sub string", "Number", true));
		mql.addParam(new MQLParam("endIndex", "The end of the sub string", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string substring", "returns a new string that is a substring of this string. the substring begins with the character at the specified index and extends to the end of this string.<br>", "string substring \"azertyaze\" 3", "rtyaze", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		mql.addParam(new MQLParam("index", "The begin of the sub string", "Number", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string substring", "returns a new string that is a substring of this string. the substring begins at the specified beginindex and extends to the character at index endindex - 1. thus the length of the substring is endindex-beginindex<br>", "string substring \"azertyaze\" 3 5", "rt", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		mql.addParam(new MQLParam("beginIndex", "The begin of the sub string", "Number", true));
		mql.addParam(new MQLParam("endIndex", "The end of the sub string", "Number", true));
		functions.get("String").add(mql);
		...
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string empty_if_null", "set the string to empty if the string is null<br>", "string empty_if_null \"a b@mail.com\"", "a b@mail.com", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string null_if_empty", "set the string to null if the string is empty<br>", "string null_if_empty \"a b@mail.com\"", "a b@mail.com", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string trim", "returns the string without space character on the right, left and with one space inside<br>", "string trim \" aze   rty \"", "aze rty", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		...
		mql.addParam(new MQLParam("data", "The data", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string ucase", "converts of all the characters in this string to upper case using the rules of the default locale<br>", "string ucase \"azerty\"", "AZERTY", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string unhex", "convert a hexadecimal number to (bigint) number<br>", "string unhex 97", "151", null, null, null, null, false, "");
		mql.addParam(new MQLParam("hex", "The hex number", "String", true));
		functions.get("String").add(mql);
		...
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "string zero", "return a 0 if empty string else return the string<br>", "string zero \"az'erty\"", "az'erty", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "The string", "String", true));
		functions.get("String").add(mql);
		...
		mql = new MQLDocumentation(true, "type is_bool", "check if a value is equal than two booleans<br>", "type is_bool 1 1 0", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		...
		mql = new MQLDocumentation(true, "type is_enum", "check if a value is a valid enum", "type is_enum 1 1,2,3", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		mql.addParam(new MQLParam("values", "The values", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_char", "check if a value is char type (with size)<br>", "type is_char 1 1", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		mql.addParam(new MQLParam("size", "The char size authorized", "Number", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_date", "check if a value is a valid date (example: 1980-06-18) in english format<br>", "type is_date \"1980-06-18\"", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("date", "The date", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_decimal", "check if a value is a decimal number or not<br>", "type is_decimal 12.23 4 5", "1", null, null, null, null, false, "");
		...
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_email", "check if a value is an email address<br>", "type is_email \"jim@mentdb.org\"", "1", null, null, null, null, false, "");
		...
		mql.addParam(new MQLParam("stringHour", "The hour", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_hour_without_sec", "check if a value is in hour format (example: 12:35) without seconds<br>", "type is_hour_without_sec \"12:35:56\"", "0", null, null, null, null, false, "");
		mql.addParam(new MQLParam("stringHour", "The hour", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_integer", "check if a value is an integer or not (with size)<br>", "type is_integer 1456 5", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		mql.addParam(new MQLParam("size", "The char size authorized", "Number", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_number", "check if a value is a number<br>", "type is_number 1456", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_matches_regex", "performs a pattern match of a string expression expr against a pattern pat", "type is_matches_regex \"azerty\" \".*ze.*\"", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("str", "the string", "String", true));
		mql.addParam(new MQLParam("pat", "the paterne", "String", true));
		functions.get("String").add(mql);
		mql = new MQLDocumentation(true, "type is_byte", "check if a value is a byte<br>", "type is_byte 13", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_small_int", "check if a value is a small integer<br>", "type is_small_int 13000", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_medium_int", "check if a value is a medium integer<br>", "type is_medium_int 130000", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_int", "check if a value is an integer<br>", "type is_int 1300000", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_big_int", "check if a value is a big integer<br>", "type is_big_int 1300000", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_float", "check if a value is a float number<br>", "type is_float 1300000.4", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_double", "check if a value is a double number<br>", "type is_double 1300000.4", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_timestamp", "check if a value is a timestamp format (example: '2009-06-18 12:00:00')<br>", "type is_timestamp \"2009-06-18 12:00:00\"", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_valid_date", "check if a date is valid.<br>", "type is_valid_date \"1980-06-18\"", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("dateToValidate", "The date", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_valid_date", "check if a date is valid.<br>", "type is_valid_date \"1980-06-18\" \"yyyy-MM-dd\"", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("dateToValidate", "The date", "String", true));
		mql.addParam(new MQLParam("format", "The date format", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_valid_time", "check if a time is valid.<br>", "type is_valid_time \"12:00:01\"", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("timeToValidate", "The time (12:00:01)", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_valid_timestamp", "check if a timestamp is valid.<br>", "type is_valid_timestamp \"1980-06-18 12:00:01\"", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("timestampToValidate", "The timestamp", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_valid_timestamp", "check if a timestamp is valid.<br>", "type is_valid_timestamp \"1980-06-18 12:00:01\" \"yyyy-MM-dd HH:mm:ss\"", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("timestampToValidate", "The timestamp", "String", true));
		mql.addParam(new MQLParam("format", "The format (ex: yyyy MM dd HH:mm:ss)", "String", true));
		functions.get("Type").add(mql);
		mql = new MQLDocumentation(true, "type is_varchar", "check if a value is varchar type (with size)<br>", "type is_varchar 1 1", "1", null, null, null, null, false, "");
		mql.addParam(new MQLParam("value", "The value", "String", true));
		mql.addParam(new MQLParam("size", "The char size authorized", "Number", true));
		functions.get("Type").add(mql);
