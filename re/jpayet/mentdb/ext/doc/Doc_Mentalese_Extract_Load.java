...
public class Doc_Mentalese_Extract_Load {
	...
	public static void init(LinkedHashMap<String, Vector<MQLDocumentation>> functions,
		...
		page_description.put("External REST API", "<img src='images/p.png' style='vertical-align: middle;'>You can call remote web services from MentDB."+
				"<br><img src='images/p.png' style='vertical-align: middle;'>And trigger your REST web services in mental process executions."+
		...
		functions.get("External REST API").add(mql);
		mql = new MQLDocumentation(true, "rest https", "To execute a REST request through HTTPS protocol", "json load \"keyId\" \"{}\";\n" + 
				"json iobject \"keyId\" / \"x-user\" \"admin\" STR;\n" + 
				"json iobject \"keyId\" / \"x-password\" \"pwd\" STR;\n" + 
				"rest https get \"https://localhost:9999/api/addition\" \"v1=1&v2=6\" (json doc \"keyId\";);", "{\n" + 
						"  \"result\": \"7\",\n" + 
						"  \"MentDB\": \"1.0.0\",\n" + 
						"  \"session\": \"3\",\n" + 
						"  \"time\": \"0s\",\n" + 
						"  \"user\": \"admin\",\n" + 
						"  \"status\": \"OK\",\n" + 
						"  \"timestamp\": \"2017-12-10 21:44:26\",\n" + 
						"  \"token\": \"eyJhbGciOiJIUzI1NiJ9..gz1u7GNOxbSuNiZiTo_7PckfUUorEuD3kYMdfwTwetc\"\n" + 
						"}", null, null, null, null, false, "");
		mql.addParam(new MQLParam("method", "The method (get|post|put|delete)", "string", true));
		mql.addParam(new MQLParam("beginUrl", "The begin url", "string", true));
		mql.addParam(new MQLParam("endUrl", "The end url", "string", true));
		...
		page_description.put("External SOAP API", "<img src='images/p.png' style='vertical-align: middle;'>You can call remote web services from MentDB."+
				"<br><img src='images/p.png' style='vertical-align: middle;'>And trigger your SOAP web services in mental process executions."+
				"<br><img src='images/p.png' style='vertical-align: middle;'>HTTP or HTTPS.");
		...
		mql = new MQLDocumentation(true, "mail download imap", "Download mail from a IMAP mail box.", 
				"-> \"[receive_dir]\" \"tmp\";\n" + 
				"\n" + 
