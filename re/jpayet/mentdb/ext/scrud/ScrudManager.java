	...
	public static String db_db_to_db(SessionThread session, String cmId, String tablename) throws Exception {
		...
		try {
			...
			return "script create exe \""+cmId+"."+tablename+".db_to_db\" false 1\n" + 
					...
					"	parameter add \""+cmId.toUpperCase()+"."+tablename.toUpperCase()+".DB_TO_DB.lock\" null 0;\n" + 
					"	parameter add \""+cmId.toUpperCase()+"."+tablename.toUpperCase()+".DB_TO_DB.err\" \"\" 0;\n" + 
					"	parameter add \""+cmId.toUpperCase()+"."+tablename.toUpperCase()+".DB_TO_DB.ts\" \"\" 0;\n" + 
					"	parameter add \""+cmId.toUpperCase()+"."+tablename.toUpperCase()+".DB_TO_DB.pk\" \"0\" 0;\n" + 
					"\n" + script_param_init+
					"	\n" + 
	...
	public static String db_csv_to_db(SessionThread session, String cmId, String tablename, String filePath, String columnSeparator, String quoteChar, String forceColumnNames) throws Exception {
		...
		try {
			...
			return "script create exe \""+cmId+"."+tablename+".csv_to_db\" false 1\n" + 
					...
					"	\n" + 
					"	#To create parameters;\n" + 
					"	parameter add \""+cmId.toUpperCase()+"."+tablename.toUpperCase()+".CSV_TO_DB.lock\" null 0;\n" + 
					"	parameter add \""+cmId.toUpperCase()+"."+tablename.toUpperCase()+".CSV_TO_DB.err\" \"\" 0;\n" + 
					"	parameter add \""+cmId.toUpperCase()+"."+tablename.toUpperCase()+".CSV_TO_DB.ts\" \"\" 0;\n" + 
					"	\n" + 
					"	#Execute only if not use;\n" + 
