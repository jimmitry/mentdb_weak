...
public class OperatorFx {
	...
	public static String and(SessionThread session, String boolValue1, String boolValue2, EnvManager env, String parent_pid, String current_pid) throws Exception {
		...
		String r1 = CommandManager.executeAllCommands(false, session, Misc.splitCommand(boolValue1), env, parent_pid, current_pid);
		
		if (r1==null) return "0";
		else if (r1.equals("1")) {
			
			//Execute the second command
			String r2 = CommandManager.executeAllCommands(false, session, Misc.splitCommand(boolValue2), env, parent_pid, current_pid);
