...
public class FileFx {
	...
	public static void start_watch_service(String skey, String user, String directory, String scriptName) throws Exception {
	...
	//Create a new file
	public static String create(String filePath, String data) throws Exception {
	...
	public static String create(String filePath, String str, String encoding) throws Exception {
	...
	public static String append(String filePath, String str) throws Exception {
	...
	public static String append(String filePath, String str, String encoding) throws Exception {
	...
	//Load a file
	public static String load(String filePath, String encoding) throws IOException, Exception {
	...
	public static String copy_dir(String oldDirPath, String newDirPath) throws Exception {
		...
		if (dirList!=null) {
			...
			for (int i=0; i<dirList.length; i++) {
				...
				if (!currentFileObject.isDirectory()) {
					...
					//Copy the file
					copy_file(oldDirPath+"/"+currentFileOrDirectory, newDirPath+"/"+currentFileOrDirectory);

				} else {

					//Copy the directory
					copy_dir(oldDirPath+"/"+currentFileOrDirectory, newDirPath+"/"+currentFileOrDirectory);
	...
	public static String copy_file(String oldFilePath, String newFilePath) throws Exception {
	...
	public static String copy_format(String source, String srcEncoding, String target, String tgtEncoding) throws Exception {
	...
	public static String b64_read(String filePath) throws Exception {
	...
	public static String b64_write(String dataInB64Format, String filePath) throws Exception {
	...
	public static String reader_open(EnvManager env, String fileReaderId, String filePath, String type, String encoding) throws Exception {
	...
	public static String writer_open(EnvManager env, String fileWriterId, String filePath, String appendMode, String type, String encoding) throws Exception {
