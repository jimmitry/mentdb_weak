...
public class DQManager {
	...
	public static void init(long sessionId) throws Exception {
		...
		Record.add(sessionId, "DQ[]", param.toJSONString());
		
	}
	
	@SuppressWarnings("unchecked")
	public static void set(long sessionId, String key, String algo) throws Exception {
		
		//Get the node
		JSONObject recNode = Record.getNode(sessionId, "DQ[]");

		recNode.put(key.replace(":", " "), algo);
		
		Record.update(sessionId, "DQ[]", recNode.toJSONString());
	...
	public static JSONObject show(long sessionId) throws Exception {
		...
		return Record.getNode(sessionId, "DQ[]");
		
	}
	
	public static String generate(long sessionId, String cmId, String table, String fieldname, String algorithms, String sql) throws Exception {
		...
		for(int i=0;i<algo.size();i++) {
			...
			String mql = DQManager.get_algo(sessionId, key).replace("[VAR]", "[T_"+fieldname+"]");
	...
	public static String get_algo(long sessionId, String key) throws Exception {
	...
	@SuppressWarnings("unchecked")
	public static JSONObject db_show_data(SessionThread session, String cmId, String query, String title) throws Exception {
