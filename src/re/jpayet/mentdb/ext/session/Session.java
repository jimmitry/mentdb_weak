		...
		for (Entry<String, WebSocketThread> e : Session.allSessions.entrySet()) {
			...
			try {
				...
				if (e.getKey().equals(user)) {
					...
					String bot_is_male = FileFx.ini(null, "bots"+File.separator+bot+File.separator+"bot.conf", "BOT", "IS_MALE");
					String bot_lang = FileFx.ini(null, "bots"+File.separator+bot+File.separator+"bot.conf", "BOT", "LANG");
