...
public class SymbolThreadFr implements Runnable {
	...
	public SymbolThreadFr(Database db, String c, String word, ConcurrentHashMap<String, Integer> search) {
		this.c = c;
		this.word = word;
		this.search = search;
		this.db = db;
	...
	public void run() {
		...
		try {
			...
			if (db.allSymbolsFr.containsKey(c)) {
				...
				List<String> words = new ArrayList<String>(db.allSymbolsFr.get(c).keySet());
