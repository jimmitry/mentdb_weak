...
public class SearchThreadFr implements Runnable {
	...
	public SearchThreadFr(Database db, byte city, byte zone, String word, int depth, ConcurrentHashMap<Long, Double> found, ConcurrentHashMap<Long, Integer> found_depth, String text) {
	...
	public void run() {
		...
		try {
			...
			Vector<Long> v_rel = db.pilesFr.get(word);
