...
public class BotManager {
	...
	public static void create_bot(String botName, String is_male, String lang) throws Exception {
		...
		FileFx.create(null, "bots"+File.separator+botName+File.separator+"bot.conf", "[BOT]\n"
				+ "IS_MALE="+is_male+"\n"
				+ "LANG="+lang+"\n");
	...
	public static String set_aiml_file(EnvManager env, String botName, String filename, String xml) throws Exception {
		...
		FileFx.create(null, "bots"+File.separator+botName+File.separator+"aiml"+File.separator+filename, xml);
	...
	public static HashMap<String, Chat> all_chat_bots = new HashMap<String, Chat>();
	
	public static Chat get_chat_obj(String botName) {
		
		if (!all_chat_bots.containsKey(botName)) {
			
			all_chat_bots.put(botName, new Chat(bots.get(botName)));
			
		}
		
		return all_chat_bots.get(botName);
	...
	public static JSONObject execute(String botName, String user, String request) throws Exception {
		...
		Chat chatSession = get_chat_obj(botName);
