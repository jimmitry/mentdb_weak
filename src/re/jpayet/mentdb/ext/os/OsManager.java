...
public class OsManager {
	...
	public static String execute(String user, String json, String min_wait) throws Exception {
		...
		if (!GroupManager.isGrantedUser("sys", user)) {
			throw new Exception("Sorry, to control an OS, "+user+" must be granted with 'sys'.");
		}
